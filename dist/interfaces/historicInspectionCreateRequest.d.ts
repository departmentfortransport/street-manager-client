...
import { DefectFixedOnsite, InspectionType, InspectionCategory, InspectionOutcome } from './referenceTypes';
import { HistoricFailureReasonDetails } from './historicFailureReasonDetails';
export interface HistoricInspectionCreateRequest extends BaseHistoricWorkCreateRequest {
    ...
    /** See business rules section 10.3 - Inspection outcomes */
    failure_reason_details?: HistoricFailureReasonDetails[];
