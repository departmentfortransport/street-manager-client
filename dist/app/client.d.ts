...
export declare class StreetManagerApiClient {
    ...
    createLaneRentalAssessment(requestConfig: RequestConfig, workReferenceNumber: string, permitReferenceNumber: string, laneRentalAssessmentCreateRequest: LaneRentalAssessmentCreateRequest): Promise<void>;
    private httpHandler;
    private handleError;
