...
class StreetManagerApiClient {
    ...
    unlinkSection81FromPermit(requestConfig, workReferenceNumber, permitReferenceNumber, unlinkSection81FromPermitRequest) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getSampleInspectionTarget(requestConfig, sampleInspectionTargetReferenceNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.get(`/sample-inspection-targets/${sampleInspectionTargetReferenceNumber}`, this.generateRequestConfig(requestConfig)));
        });
    }
    ...
    closeSampleInspectionTarget(requestConfig, sampleInspectionTargetReferenceNumber, closeSampleInspectionTargetRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.put(`/sample-inspection-targets/${sampleInspectionTargetReferenceNumber}/close`, closeSampleInspectionTargetRequest, this.generateRequestConfig(requestConfig)));
        });
    }
    ...
    withdrawInspection(requestConfig, workReferenceNumber, inspectionReferenceNumber, inspectionWithdrawRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.put(`/works/${workReferenceNumber}/inspections/${inspectionReferenceNumber}/withdraw`, inspectionWithdrawRequest, this.generateRequestConfig(requestConfig)));
        });
    }
    httpHandler(request) {
        return __awaiter(this, void 0, void 0, function* () {
